...
test_that("DD_TMB assess model", {
  ...
  pro <- profile_likelihood(res, R0 = seq(0.75, 1.25, 0.025), h = seq(0.95, 1, 0.0025), save_dir = tdir)
...
test_that("DD_SS assess model", {
  ...
  pro <- profile_likelihood(res, R0 = seq(0.75, 1.25, 0.025), h = seq(0.9, 0.99, 0.01), save_dir = tdir)
  expect_type(pro, "list")
  expect_true(is.data.frame(pro))
