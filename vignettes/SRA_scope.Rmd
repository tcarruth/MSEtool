...
$$ R^{\textrm{eq}} = 
\begin{cases}
      \dfrac{\alpha^{\textrm{BH}}\phi^{\textrm{eq}} - 1}{\beta^{\textrm{BH}}\phi^{\textrm{eq}}} & \textrm{if Beverton-Holt stock-recruit relationship}\\
      \dfrac{\log(\alpha^{\textrm{Ricker}}\phi^{\textrm{eq}})}{\beta^{\textrm{Ricker}}\phi^{\textrm{eq}}} & \textrm{if Ricker stock-recruit relationship}
\end{cases},
$$
where $\phi^{\textrm{eq}}$ is the spawners-per-recruit when the mortality is $Z^{\textrm{eq}}_a$. From steepness $h$, $\alpha^{\textrm{BH}} = \frac{4h}{(1-h)\phi_0}$, $\beta^{\textrm{BH}} = \frac{5h-1}{(1-h)B^S_0}$, $\alpha^{\textrm{Ricker}} = \frac{(5h)^{1.25}}{\phi_0}$, $\beta^{\textrm{Ricker}} = \frac{\log(5h)}{B^S_0}$, where $\phi_0$ and $B^S_0$ are unfished spawners-per-recruit and unfished spawning biomass, respectively.
