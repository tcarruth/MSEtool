...
$$\alpha \Sigma_{a=1}^A l_a m_a w_a \exp(-ra) = 1.$$

Equation 12 is modified to include the $\alpha$ term from the stock-recruit relationship (Stanley et al. 2009).
