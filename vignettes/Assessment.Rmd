...
From $MSY$ and $u_{MSY}$ estimates, then the stock-recruit parameters $\alpha$ and $\beta$ are:
$$ \begin{align}
\alpha &= \dfrac{1}{\phi_{MSY}(1-u_{MSY})}\exp\left(\dfrac{\phi_{MSY} - u\phi'_{MSY}(1-u_{MSY})}{(u\phi'_{MSY} + \phi_{MSY})(1-u_{MSY}) + u\phi_{MSY}}\right)\\
\beta &= \dfrac{u_{MSY}\phi_{MSY}\log[\alpha\phi_{MSY}(1-u_{MSY})]}{MSY(1-u_{MSY})}
\end{align}$$
