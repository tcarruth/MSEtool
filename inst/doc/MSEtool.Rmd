...
# Introduction 
The MSEtool package is an extension of the DLMtool R package for implementing closed-loop simulation testing of management procedures, a process often referred to as management strategy evaluation (MSE). Whereas DLMtool is primarily designed for testing data-limited management procedures, MSEtool provides an object-oriented framework for creating data-rich management procedures (MPs), which typically involve combining an assessment model with a harvest control rule to provide a fishery management recommendation. MSEtool management procedures are designed to be used with the operating model of DLMtool through the `runMSE` function. The user guide to the DLMtool package is accessible via
