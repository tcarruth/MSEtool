...
#' @param distE A log error term for sampling stock fractions from the fracs vector
#' @param probE Logit (normal) error for sampling desired probability of staying either by area (prob is same length as dist) or the mean probability of staying (prob is a single number)
#' @param prob2 Optional vector prob and dist long. Upper bounds on uniform sampling of probability of staying
#' @author T. Carruthers
#' @export simmov
#' @import TMB
