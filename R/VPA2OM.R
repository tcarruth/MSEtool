...
#' weight-at-age, length-at-age and Maturity-at-age to define a fully described DLMtool / MSEtool operating model. Tthe user still 
...
VPA2OM<-function(Name="A fishery made by VPA2OM", 
                 ...
                 recind=2, plusgroup=T, altinit=0, fixq1=T,
                 report=F, silent=F
  ...
  temp<-new('OM', Albacore, Generic_Fleet, Obs, Imp)
