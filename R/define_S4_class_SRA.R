          ...
          function(x, compare = TRUE, filename = "SRA_scope", dir = tempdir(), sims = 1:x@OM@nsim, Year = NULL, open_file = TRUE, quiet = TRUE, ...) {
            ...
            if(compare) {
              ...
              compare_rmd <- c("## Updated OM {.tabset}\n",
                               ...
                               "matplot(Year, t((Hist@TSdata$SSB - x@SSB[, 1:OM@nyears])/Hist@Ref$SSB0), typ = \"l\", col = \"black\", xlab = \"Year\", ylab = \"Difference in relative SSB\")",
                               "abline(h = 0, lwd = 3, lty = 2)",
                               "```\n",
                               "",
                               ...
                               "matplot(Year, t(Hist@TSdata$Rec/OM@cpars$R0 - x@NAA[, 1:OM@nyears, 1]/OM@cpars$R0), typ = \"l\", col = \"black\", xlab = \"Year\", ylab = \"Difference in relative recruitment\")",
                               "abline(h = 0, lwd = 3, lty = 2)",
                               "```\n",
                               "",
