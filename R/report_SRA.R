...
summary_SRA <- function(Assessment) {
  ...
  output <- list(model = "Stock Reduction Analysis (SRA)",
...
plot_yield_SRA <- function(data, report, umsy, msy, u.vector = seq(0, 3 * umsy, length.out = 100), SR, xaxis = c("U", "Biomass", "Depletion")) {
