...
#' @keywords internal
getq_multi <- function(x, D, SSB0, nareas, maxage, N, pyears, M_ageArray, Mat_age, Asize, Wt_age,
                  FleetP, Perr, mov, SRrel, hs, R0a, SSBpR, aR, bR,
                  maxF, MPAc, CFp, useCPP=TRUE) {
  ...
  opt <- optim(par,optQ_multi, depc=D[x], SSB0c=SSB0[x], nareas=nareas, maxage=maxage, Ncurr=Np[x,,1,],
